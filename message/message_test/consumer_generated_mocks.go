...
func (mock *KafkaMessageMock) Commit() {
	if mock.CommitFunc == nil {
		panic("KafkaMessageMock.CommitFunc: method is nil but KafkaMessage.Commit was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *KafkaMessageMock) GetData() []byte {
	if mock.GetDataFunc == nil {
		panic("KafkaMessageMock.GetDataFunc: method is nil but KafkaMessage.GetData was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *KafkaMessageMock) Offset() int64 {
	if mock.OffsetFunc == nil {
		panic("KafkaMessageMock.OffsetFunc: method is nil but KafkaMessage.Offset was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *KafkaConsumerMock) Incoming() chan kafka.Message {
	if mock.IncomingFunc == nil {
		panic("KafkaConsumerMock.IncomingFunc: method is nil but KafkaConsumer.Incoming was just called")
	}
	callInfo := struct {
	}{}
